...
// configuration step. It creates a namespace called `cpp_grok`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_grok::cmake::project_name, cpp_grok::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_grok::cmake::project_version);
      return EXIT_SUCCESS;
    }
